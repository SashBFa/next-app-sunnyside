        ...
        <div className="flex flex-col items-center sm:flex-row-reverse">
          <div className="sm:w-2/4 lg:w-4/5">
            ...
            <div className="text-lg my-6 sm:text-right sm:ml-12">
              ...
              <p>
                With more than 15 years of experience in the field, the
                Sunnyside team puts its expertise at your service. We take the
                time to listen to you in order to offer you
