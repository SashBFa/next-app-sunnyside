...
const Services = () => {
  return (
    <>
      ...
      <Modulo color={false}>
        <div className="flex flex-col items-center sm:flex-row max-w-screen-xl xl:m-auto">
      ...
      <Modulo color={false}>
        <div className="flex flex-col items-center lg:flex-row-reverse">
          ...
          <div className="text-lg mt-6">
            <p>
              Do you want to gain notoriety? Attract new customers? Increase
              your turnover? All this, thanks to the web? Our digital
              communication agency helps you achieve your various web
              objectives, by creating for you a personalized and optimal digital
              presence, an effective website with an attractive web design and
              relevant natural referencing (SEO).
              <b>
            ...
            <p>
              ...
              implemented. This allows us to make your project tangible,
